...
Run a Cargo build or bench command with profile release-perf and force frame
pointers for reliable samply, perf, and flamegraph stack unwinding. Existing
RUSTFLAGS are preserved; the required flag is appended last.
EOF
}
