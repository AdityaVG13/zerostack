...
//!
//! Restored in-repo (module layout merged) after the hub liquidated the
//! shared `zero-testkit` package; this module originally lived here and was
//! ported to the hub so all engines shared one lock helper.
...
mod tests {
    ...
    const TEST_KEY: &str = "GRAPHZERO_TEST_SUPPORT_SCOPED_ENV_VARS_TEST";
    ...
    fn set_one_restores_prior_absence() {
        const KEY: &str = "GRAPHZERO_TEST_SUPPORT_SET_ONE_TEST";
