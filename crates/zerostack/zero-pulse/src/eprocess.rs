...
/// Anytime-valid Bernoulli e-process for the live Pulse failure stream. Under the null that the
/// failure probability is at most `null_failure_rate`, the e-value is a non-negative
/// supermartingale.
#[derive(Debug, Clone)]
