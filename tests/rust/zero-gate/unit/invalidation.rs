    ...
    fn contract_and_external_schema_digests_are_stable() {
        // 514fb78e624b17bb85f6fad89440a3962fbf3c7af4da3bfefe371fe8e0c2fdb8
        assert_eq!(
            invalidation_intake_contract_digest_v1(),
            DigestV1::from_bytes([
                0x51, 0x4f, 0xb7, 0x8e, 0x62, 0x4b, 0x17, 0xbb, 0x85, 0xf6, 0xfa, 0xd8, 0x94, 0x40,
                0xa3, 0x96, 0x2f, 0xbf, 0x3c, 0x7a, 0xf4, 0xda, 0x3b, 0xfe, 0xfe, 0x37, 0x1f, 0xe8,
                0xe0, 0xc2, 0xfd, 0xb8,
            ])
        );
        assert_eq!(
