...
CLEANUP_PATH=ROOT.parent/'docs/release-cleanup-manifest-v1.json'
...
EXPECTED={
 'tokenzero':{'crates/tokenzero-core/Cargo.toml:tokenzero-core:tokenzero-core','crates/tokenzero-recovery/Cargo.toml:tokenzero-recovery:tokenzero-recovery','crates/tokenzero-runtime/Cargo.toml:tokenzero-runtime:tokenzero-runtime','crates/tokenzero-engine/Cargo.toml:tokenzero-engine:tokenzero-engine','crates/tokenzero-filters/Cargo.toml:tokenzero-filters:tokenzero-filters','crates/tokenzero-codemode/Cargo.toml:tokenzero-codemode:tokenzero-codemode','crates/tokenzero-mcp-compat/Cargo.toml:tokenzero-mcp-compat:tokenzero-mcp-compat','crates/tokenzero/Cargo.toml:tokenzero:tokenzero','crates/tokenzero-install/Cargo.toml:tokenzero-install:tokenzero-install','crates/tokenzero-pulse/Cargo.toml:tokenzero-pulse:tokenzero-pulse','fuzz/Cargo.toml:tokenzero-fuzz:tokenzero-fuzz','xtask/Cargo.toml:tokenzero-xtask:tokenzero-xtask','crates/tokenzero/src/main.rs:tokenzero:tokenzero','crates/tokenzero/src/bin/tokenzero_mcp.rs:tokenzero:tokenzero-mcp','crates/tokenzero/src/bin/tokenzero_codemode.rs:tokenzero:tokenzero-codemode','fuzz/fuzz_targets/expand_fragment_differential.rs:tokenzero-fuzz:expand_fragment_differential','xtask/src/main.rs:tokenzero-xtask:tokenzero-xtask'},
 'fszero':{'Cargo.toml:fs-zero:fs-zero','crates/fszero-codemode/Cargo.toml:fszero-codemode:fszero-codemode','crates/fszero-mcp/Cargo.toml:fszero-mcp:fszero-mcp','crates/fszero-shim/Cargo.toml:fszero-shim:fszero-shim','xtask/Cargo.toml:zerostack-xtask:zerostack-xtask','crates/fszero-shim/src/main.rs:fs-zero:fszero','crates/fszero-codemode/src/main.rs:fszero-codemode:fszero-codemode','crates/fszero-mcp/src/main.rs:fszero-mcp:fszero-mcp','crates/fszero-shim/src/main.rs:fszero-shim:fszero','crates/fszero-shim/src/main.rs:fszero-shim:fszero-shim','xtask/src/main.rs:zerostack-xtask:zerostack-xtask'},
 'graphzero':{'crates/graphzero-cli/Cargo.toml:graphzero:graphzero','crates/graphzero-coverage/Cargo.toml:graphzero-coverage:graphzero-coverage','crates/graphzero-extract/Cargo.toml:graphzero-extract:graphzero-extract','crates/graphzero-pack/Cargo.toml:graphzero-pack:graphzero-pack','crates/graphzero-query/Cargo.toml:graphzero-query:graphzero-query','crates/graphzero-reserve/Cargo.toml:graphzero-reserve:graphzero-reserve','crates/graphzero-scip/Cargo.toml:graphzero-scip:graphzero-scip','crates/graphzero-scip/tools_gen/Cargo.toml:gen-fixture:gen-fixture','crates/graphzero-semantic/Cargo.toml:graphzero-semantic:graphzero-semantic','crates/graphzero-store/Cargo.toml:graphzero-store:graphzero-store','crates/graphzero-test-support/Cargo.toml:graphzero-test-support:graphzero-test-support','crates/graphzero-types/Cargo.toml:graphzero-types:graphzero-types','crates/graphzero-why/Cargo.toml:graphzero-why:graphzero-why','crates/graphzero-cli/src/main.rs:graphzero:graphzero','crates/graphzero-cli/src/bin/graphzero_mcp.rs:graphzero:graphzero-mcp','crates/graphzero-cli/src/bin/graphzero_codemode.rs:graphzero:graphzero-codemode','crates/graphzero-query/src/bin/gzero.rs:graphzero-query:gzero','crates/graphzero-query/src/bin/gz_surface_bench_worker.rs:graphzero-query:gz-surface-bench-worker','crates/graphzero-query/src/bin/gz_raw_worker.rs:graphzero-query:gz-raw-worker','crates/graphzero-scip/tools_gen/src/main.rs:gen-fixture:gen-fixture'}
}

SIBLING_ROOTS={"tokenzero":ROOT.parent/"TokenZero","fszero":ROOT.parent/"FSZero","graphzero":ROOT.parent/"GraphZero"}
...
class TopologyTests(unittest.TestCase):
    ...
    def test_worker_boundary_and_adapters(self)->None:
        ...
        adr=(ROOT.parent/"docs/adr/0001-canonical-engine-topology.md").read_text(encoding="utf-8")
        line=next(line for line in adr.splitlines() if line.startswith("Canonical prohibition tokens:"))
        adr_set={item.strip() for item in line.split(":",1)[1].split(",")}
        self.assertEqual(adr_set,RAW_WORKER_PROHIBITIONS)
