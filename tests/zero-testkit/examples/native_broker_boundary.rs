...
const SOURCE_INPUTS: [(&str, &[u8]); 20] = [
    ...
    (
        "tests/zero-testkit/examples/native_broker_boundary.rs",
        include_bytes!(concat!(
            env!("CARGO_MANIFEST_DIR"),
    ...
    (
        "tests/zero-testkit/src/aggregate_broker_gate.rs",
        include_bytes!(concat!(
            env!("CARGO_MANIFEST_DIR"),
    ...
    (
        "tests/zero-testkit/src/kernel_fixture.rs",
        include_bytes!(concat!(
            env!("CARGO_MANIFEST_DIR"),
    ...
    (
        "tests/zero-testkit/conformance/two-phase-gate/v1/index.json",
        include_bytes!(concat!(
            env!("CARGO_MANIFEST_DIR"),
    ...
    (
        "tests/zero-testkit/conformance/two-phase-gate/v1/schema.json",
        include_bytes!(concat!(
            env!("CARGO_MANIFEST_DIR"),
    ...
    (
        "tests/zero-testkit/conformance/two-phase-gate/v1/vectors.json",
        include_bytes!(concat!(
            env!("CARGO_MANIFEST_DIR"),
    ...
    (
        "tests/zero-testkit/conformance/two-phase-gate/v1/runners/python/verify_v1.py",
        include_bytes!(concat!(
            env!("CARGO_MANIFEST_DIR"),
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let receipt = json!({
        ...
        "model_or_spec_version": "zerostack.two_phase_kernel.v5",
        "kernel_contract_digest": DigestV1::from_bytes(two_phase_contract_digest_v5()),
