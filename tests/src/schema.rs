...
pub const CANONICAL_DISPATCH_SCHEMA: &str =
    include_str!("../contracts/canonical-dispatch.schema.json");
...
impl SchemaName {
    ...
    fn schema_json(self) -> &'static str {
        match self {
            ...
            Self::CapabilityManifest => include_str!("../contracts/capability_manifest.json"),
            Self::Telemetry => include_str!("../contracts/telemetry.json"),
            Self::Error => include_str!("../contracts/error.json"),
            Self::ExecutionRecord => include_str!("../contracts/execution_record.json"),
            Self::LimitsEcho => include_str!("../contracts/limits_echo.json"),
            Self::RawWorkerV2 => include_str!("../contracts/raw-worker-v2.schema.json"),
        }
    }
}
